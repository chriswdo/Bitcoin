...
public class User implements Serializable{
	private String cn_user_id; //Ö÷¼üID
	private String cn_user_name; //µÇÂ¼Ãû
	private String cn_user_password; //ÃÜÂë
	private String cn_user_token; //µÇÂ¼ÁîÅÆ
	private String cn_user_desc; //êÇ³Æ
