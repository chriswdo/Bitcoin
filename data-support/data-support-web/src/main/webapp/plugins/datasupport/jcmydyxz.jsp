...
<body class="u_scroll">
	<div class="up-container-fluid">
		...
		<div class="u_tab_body" id="table_grid">
			...
			<form class="u_form" id="layer-editor"
				style="display: none; padding: 15px;">
				<table width="100%">
					<tbody>
						<tr>
							<td align="right" width="20%"><label
								class="up-control-label" style="padding-right: 15px;">列名</label></td>
							<td width="80%"><input type="text" name="FD_ZDMC"
								id="FD_ZDMC" class="up-form-control" style="width: 60%;" /></td>
						</tr>
						<tr>
							<td align="right" width="20%"><label
								class="up-control-label" style="padding-right: 15px;">字段类型</label></td>
						...
						<tr>
							<td align="right" width="20%"><label
								class="up-control-label" style="padding-right: 15px;">字段长度</label></td>
							<td width="80%"><input type="text" id="FD_ZDCD"
								name="FD_ZDCD" class="up-form-control" style="width: 60%;" /></td>
						</tr>
						<tr>
							<td align="right" width="20%"><label
								class="up-control-label" style="padding-right: 15px;">字段精度</label></td>
						...
						<tr>
							<td align="right" width="20%"><label
								class="up-control-label" style="padding-right: 15px;">缺省值</label></td>
							<td width="80%"><input type="text" id="FD_QSZ" name="FD_QSZ"
								class="up-form-control" style="width: 60%;" /></td>
						</tr>
						<tr>
							<td align="right" width="20%">
								<label class="up-control-label" style="padding-right:15px;">是否可为空</label>
							</td>
							<td width="80%">
								<label class="u_check">
						...
						<tr>
							<td align="right" width="20%"><label
								class="up-control-label" style="padding-right: 15px;">字段备注</label></td>
                 	...
                 	require(['layer'], function() {
		                layer.open({
                            ...
                            if($('input:radio[name="FD_SFZJ"]:checked').val()=="Y" &&  $('input:radio[name="FD_SFKWK"]:checked').val()=="Y")
                            {
                            	...
                            	//console.log($('input:radio[name="FD_SFZJ"]:checked').val());
                            	//console.log($("#nid").val()+"saaaa");
...
/*     	  $(":radio[name='FD_SFKWK']").removeAttr("checked");
          $(":radio[name='FD_SFKWK']").next("i").removeClass("icon-u-ok-circle").addClass("icon-u-circle-thin");
          if(str=="Y"){
            	$(":radio[name='FD_SFKWK'][value='N']").attr("checked", "checked").next("i").removeClass("icon-u-circle-thin").addClass("icon-u-ok-circle");
          }else{
            	$(":radio[name='FD_SFKWK'][value='Y']").attr("checked", "checked").next("i").removeClass("icon-u-circle-thin").addClass("icon-u-ok-circle");       		
          } */
        });  
   ...
   require(['layer'], function () {     
        $("#okbtn").click(function() {
        	...
        	var param = {xxzt:$("#jclx").val(),xxmc:$("#xxmc").val(),xxms:$("#xxms").val(),xxid:'${megid}',xxbm:$("#xxbm").val(),addlist:JSON.stringify(addlist)};
            	$.ajax({
            		type : "POST",
