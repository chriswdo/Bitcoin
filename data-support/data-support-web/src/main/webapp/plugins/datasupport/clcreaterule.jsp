...
/*   		   var data = "${relist}";
  		   var  woshilist = data.replace('[','').replace(']','').split(',');
  		   $("#rulename1").val(woshilist[2].split('=')[1]); 
  		   $("#sr").val(woshilist[6].split('=')[1]);
  		   $("#sc").val(woshilist[8].split('=')[1]);
  		   $("#srb").html("<option value=\""+woshilist[7].split('=')[1]+"\" >"+woshilist[31].split('=')[1]+"</option>");
  		   $("#scb").html("<option value=\""+woshilist[9].split('=')[1]+"\" >"+woshilist[33].split('=')[1]+"</option>");
  		   $("#jobid").html(woshilist[16].split('=')[1]); 
  		   gzid=woshilist[0].split('=')[1]; */
  		   //layer.alert(gzid);
  		 //$("#jobid").attr();
            		...
            		success: function (data) {
                        if(data="ok"){
                            layer.alert("操作成功!",{closeBtn:0},function(){
                            	window.location.href="${basePath}/plugins/datasupport/clrulelist.jsp"
        						});
                         }else{
                        	 layer.alert("操作失败！");
                         }
