        ...
        $(document).ready(function() {	
            ...
            if('${uniqueid}'=="edit"){
            	var data = ${relist};
            	 ...
            	 $("#xxbm").val(data.FD_BM);
            	 $("#xxms").val(data.FD_MS);
            	 $("#xxmc").val(data.FD_XXMC);
    		 }
            
        	
        	$("#xxgrid").jqGrid({
                url: "${basePath}/xxflcontroller/getxxmetadata?xxid="+'${megid}',
               // editurl:"${basePath}/xxflcontroller/editxxmetadata?xxid="+'${megid}'+"&xxbm="+$("#xxbm").val() ,		
                datatype: "json",
                mtype: "GET",
                colModel: [{
                    label: 'IDD',
    		                ...
    		                layer.open({
    		                    ...
    		                    btn: ['确定', '取消'],
                                  ...
                                  //  layer.alert(rowData.FD_ZDMC);
                                	$.ajax({
                                		type : "POST",
                                		url : '${basePath}/xxflcontroller/getxxmetadataBymc',
                                		dataType : "text",
            		...
            		success: function (data) {
                        if(data=="ok"){
                            layer.alert("操作成功!",{closeBtn:0},function(){
                            	window.location.href="${basePath}/plugins/datasupport/messagedivide.jsp"
        						});
                         }else if(data=="repeat"){
                        	 layer.alert("字段名已存在!");
                         }else if(data=="fail"){
