...
<!-- 				<div class="up-form-group up-col-sm-24">
    ...
    function generateChart(chart){
    	...
    	$("#process_ul").width(110+((chart.length-2)<=0?0:(chart.length-2))*110+30+50);
    	var innerHtml="";
    ...
    require(['uskin'], function() {
        ...
        $("#u_pagination").pagination({
            ...
            noInfoText: "没有任何数据",
            remote : {
                url : "${basePath}/rulemacontroller/ajaxRulelistdataBygzmc?lx=0",
                success:function(data){
		                                		...
		                                		success: function (data) {
		                                            if(data=="ok"){
		                                                layer.alert("操作成功!",{closeBtn:0},function(){
		                                                	window.location.href="${basePath}/rulemacontroller/getcjruleDatapage"
		                            						});
		                                             }else{
		                                            	 layer.alert("操作失败！");
		                                             }
