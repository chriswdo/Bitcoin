    ...
    <div class="up-container-fluid">
        <form class="u_form up-clearfix" style="max-width: 500px;">
            ...
            <div class="up-form-group up-col-sm-24">
                <label class="up-control-label">主题 </label>
                    <select name="" id="xxzt" class="up-form-control">
    ...
    require(['uskin'], function() {   	
      ...
      require(['layer'], function () { 
        $("#okbtn").click(function() {
        	...
        	var param = {xxzt:$("#xxzt").val(),xxmc:$("#xxmc").val(),xxms:$("#xxms").val(),xxid:'${megid}',xxbm:$("#xxbm").val(),addlist:JSON.stringify(addlist)};
            	$.ajax({
            		type : "POST",
