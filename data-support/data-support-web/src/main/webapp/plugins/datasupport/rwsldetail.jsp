    ...
    <div class="up-container-fluid">
        <form class="up-form-inline u-margin-top20 u-margin-bottom20 up-clearfix">
              <div class="up-form-group">
                <a href="${basePath}/monitorrule/getcjMonitorpage" class="up-btn up-btn-sm up-btn-default u-add"><i class="icon-u-add-round"></i> 返回上页
                </a>
            </div>
        </form>
            ...
            remote : {
                ...
                success:function(data){
                	...
                	for(var i=0;i<recordList.length;i++){
                        if(recordList[i].FD_BZXX == "" ||recordList[i].FD_BZXX == null){
                            recordList[i].FD_BZXX = "";
                        }
                		infoStr=infoStr+"<tr><td>"+recordList[i].FD_QDSJ+"</td><td>"+
                		recordList[i].FD_JSSJ+"</td><td>"+recordList[i].FD_YXCS+"</td><td>"+
                		recordList[i].FD_ZXJG+"</td><td>"+recordList[i].FD_CLJLS+"</td><td><button class=\"up-btn up-btn-default up-btn-xs\" bzxx='"+recordList[i].bzxx+"' data-op=\""+recordList[i].ID+"\" id=\"option_"+recordList[i].ID+"\">脚本日志</button></td></tr>";
                	}
