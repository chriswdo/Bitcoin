...
@Entity
@Table(name="DSJZC_JCMXDY")
public class Jcmxdy implements Serializable {
	private String id;// id
	private String fd_jcmxmc;// 信息名称
	private String fd_lx;//0:数据仓库；1：数据集市 
	...
	@Column(name = "FD_JCMXMC", length = 255)
	public String getFd_jcmxmc() {
		return fd_jcmxmc;
	}

	public void setFd_jcmxmc(String fd_jcmxmc) {
		this.fd_jcmxmc = fd_jcmxmc;
	}
